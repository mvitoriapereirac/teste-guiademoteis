...
void main() {
  test('Motel fromJson deve criar uma instância correta', () {
    final json = {
  ...
  test('Motel toJson deve retornar um JSON válido', () {
    final motel = const Motel(fantasia: "Motel Teste", suites: [], logo: '', bairro: '', distancia: 0, qtdFavoritos: 0, qtdAvaliacoes: 0, media: 0);

    final json = motel.toJson();

    expect(json["fantasia"], "Motel Teste");
    expect(json["suites"], isEmpty);
  });
}
